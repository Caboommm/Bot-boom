...
MP_ACCESS_TOKEN = "TEST-4955463544959848-012722-648e8ca92ca4f81e60e8fbcef6ff96d1-3163100557"
...
class PagamentoView(discord.ui.View):
    ...
    @discord.ui.button(label="Gerar PIX (Automático)", style=discord.ButtonStyle.success, emoji="💠")
...
@bot.event
async def on_ready():
    print(f'🔥 {bot.user} tá ON e conectado na API!')
